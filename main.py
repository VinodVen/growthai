...
def _do_migrations():
    ...
    migrations = [
        ...
        "ALTER TABLE business_profiles ADD COLUMN IF NOT EXISTS tone VARCHAR(50) DEFAULT 'friendly'",
        "ALTER TABLE business_profiles ADD COLUMN IF NOT EXISTS peak_days VARCHAR(200)",
        "ALTER TABLE business_profiles ADD COLUMN IF NOT EXISTS timezone VARCHAR(100) DEFAULT 'America/Chicago'",
